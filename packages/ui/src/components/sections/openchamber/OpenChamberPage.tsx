...
// Visual section: Theme Mode, Color Scheme, Fonts, Font Size, Spacing, Input Bar Offset (mobile)
const VisualSectionContent: React.FC = () => {
    return <OpenChamberVisualSettings visibleSettings={['theme', 'colorScheme', 'fonts', 'fontSize', 'spacing', 'inputBarOffset']} />;
};
