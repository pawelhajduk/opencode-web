...
// Visual section: Theme Mode, Color Scheme, Font Size, Spacing, Input Bar Offset (mobile)
const VisualSectionContent: React.FC = () => {
    return <OpenChamberVisualSettings visibleSettings={['theme', 'colorScheme', 'fontSize', 'spacing', 'inputBarOffset']} />;
};
